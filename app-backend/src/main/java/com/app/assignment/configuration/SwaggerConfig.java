...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Hacker News Service API").description("This API can be used to get top stories and comments from hacker news.").version("v0").build();
	}
